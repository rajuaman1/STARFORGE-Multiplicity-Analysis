...
alpha_tag = 'alpha'
R_filenames = ['M2e4_C_M_J_RT_W_R3_2e7','M2e4_C_M_J_RT_W_2e7','M2e4_C_M_J_RT_W_R30_2e7']
R_tag = 'R'
BOX_filenames = ['M2e4_C_M_J_RT_W_2e7','M2e4_C_M_J_RT_W_2e7_BOX','M2e4_C_M_J_RT_W_nodriving_2e7_BOX']
BOX_tag = 'BOX'
Z_filenames = ['M2e4_C_M_J_RT_W_2e7_alt','M2e4_C_M_J_RT_W_Zx01_2e7','M2e4_C_M_J_RT_W_Zx001_2e7']
Z_tag = 'Z'
B_filenames = ['M2e4_C_M_J_RT_W_2e7_alt','M2e4_C_M_J_RT_W_hiB_2e7','M2e4_C_M_J_RT_W_vhiB_2e7']
B_tag = 'B'
...
alt_tag = 'alt'
random_filenames = ['M2e4_C_M_J_RT_W_alpha1_2e7','M2e4_C_M_J_RT_W_2e7','M2e4_C_M_J_RT_W_alpha4_2e7','M2e4_C_M_J_RT_W_R3_2e7','M2e4_C_M_J_RT_W_2e7_BOX']
random_tag = 'random'

def all_plots(Filenames,description,adaptive_bin_no = 5):
    ...
    plt.savefig(description+'/Multiplicity_Fraction_'+description+'.png',dpi = 100)
    plt.figure(figsize = (10,10))
    Multi_Plot('Multiplicity',Systems,Files,Filenames,multiplicity='Frequency')
    plt.savefig(description+'/Companion_Frequency_'+description+'.png',dpi = 100)
    plt.figure(figsize = (10,10))
    Multi_Plot('Semi Major Axis',Systems,Files,Filenames,upper_limit=13000000,lower_limit=0)
    plt.savefig(description+'/Semi_Major_Axis_all_'+description+'.png',dpi = 100)
    plt.figure(figsize = (10,10))
    Multi_Plot('Semi Major Axis',Systems,Files,Filenames,upper_limit=1.3,lower_limit=0.7)
    plt.savefig(description+'/Semi_Major_Axis_Solar_'+description+'.png',dpi = 100)
    plt.figure(figsize = (10,10))
    Multi_Plot('Mass Ratio',Systems,Files,Filenames,upper_limit=13000000,lower_limit=0)
    plt.savefig(description+'/Mass_Ratio_all_'+description+'.png',dpi = 100)
    plt.figure(figsize = (10,10))
    Multi_Plot('Mass Ratio',Systems,Files,Filenames,upper_limit=1.3,lower_limit=0.7)
    plt.savefig(description+'/Mass_Ratio_Solar_'+description+'.png',dpi = 100)
    ...
    for n in tqdm(range(len(Files)),position = 0,desc = 'Random Sampling'):
        ...
        plt.savefig(new_file+'/Random_Sampling_'+Filenames[n]+'.png',dpi = 100)
    ...
    for n in tqdm(range(len(Files)),position = 0,desc = 'System Mass Dist'):
        ...
        plt.savefig(new_file+'/System_Mass_'+Filenames[n]+'.png',dpi = 100)
    ...
    for n in tqdm(range(len(Files)),position = 0,desc = 'Primary Mass Dist'):
        ...
        plt.savefig(new_file+'/Primary_Mass_'+Filenames[n]+'.png',dpi = 100)    
    ...
    plt.savefig(new_file+'/volume_density_multiplicity_fraction_'+description+'.png',dpi = 100)
    plt.figure(figsize = (10,10))
    Multi_Plot('Multiplicity vs Formation',Systems,Files,Filenames,adaptive_no=adaptive_nos,x_axis='mass density')
    plt.savefig(new_file+'/mass_density_multiplicity_fraction_'+description+'.png',dpi = 100)
    plt.figure(figsize = (10,10))
    ...
    plt.savefig(new_file+'/volume_density_companion_frequency_'+description+'.png',dpi = 100)
    plt.figure(figsize = (10,10))
    ...
    plt.savefig(new_file+'/mass_density_companion_frequency_'+description+'.png',dpi = 100)
...
#all_plots(alpha_filenames,alpha_tag)
#all_plots(R_filenames,R_tag)
#all_plots(BOX_filenames,BOX_tag)
#all_plots(Z_filenames,Z_tag)
#all_plots(B_filenames,B_tag)
#all_plots(ISRF_filenames,ISRF_tag)
#all_plots(alt_filenames,alt_tag)
#all_plots(random_filenames,random_tag)